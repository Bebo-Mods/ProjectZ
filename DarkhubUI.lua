--[[
  DarkHubLib - Fully Undetectable Version
  Uses gethui() for hidden container and cloneref() for all services
]]

-- Get hidden container (game scripts cannot see this)
local hiddenContainer = gethui()
if not hiddenContainer then
    error("DarkHubLib: gethui() failed - cannot load undetected")
end

-- Cloneref all services to avoid detection
...
-- Destroy existing instance if found (check hidden container too)
pcall(function()
    if hiddenContainer:FindFirstChild("DarkHubLib") then
        hiddenContainer.DarkHubLib:Destroy()
    end
end)

-- Randomize UI name to avoid signature detection
local uiName = "UI_" .. tostring(math.random(100000, 999999))

local DarkLib = {RainbowColorValue = 0, HueSelectionPosition = 0}

-- Rainbow coroutine with random delays
...
-- Draggable function with cloneref'd services
...
-- Create hidden ScreenGui
local DarkHubLib = Instance.new("ScreenGui")
DarkHubLib.Name = uiName
DarkHubLib.Parent = hiddenContainer
DarkHubLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
DarkHubLib.ResetOnSpawn = false
DarkHubLib.IgnoreGuiInset = true
DarkHubLib.ScreenInsets = Enum.ScreenInsets.None
DarkHubLib.DisplayOrder = -999  -- Hide behind everything

-- Random decoy frames to confuse detection
for i = 1, math.random(3, 8) do
    local decoy = Instance.new("Frame")
    decoy.Name = "Decoy_" .. tostring(math.random(1000, 9999))
    decoy.Size = UDim2.fromOffset(0, 0)
    decoy.BackgroundTransparency = 1
    decoy.Parent = DarkHubLib
end
    ...
    function Win:Tab(text)
        ...
        Tab.MouseButton1Click:Connect(function()
            ...
            for i, v in next, TabHolder:GetChildren() do
                if v.ClassName == "TextButton" then
                    ...
                    TweenService:Create(Tab, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
                end
            end
            Container.Visible = true
        end)
        ...
        function Cont:Button(text, callback)
            ...
            Button.MouseEnter:Connect(function()
                TweenService:Create(Button, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 44, 44)}):Play()
            end)

            Button.MouseLeave:Connect(function()
                TweenService:Create(Button, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(39, 39, 39)}):Play()
            end)

            Button.MouseButton1Click:Connect(function()
                pcall(callback)
                Ripple(Button)
                TweenService:Create(Button, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize = 0}):Play()
                task.wait(0.1)
                TweenService:Create(Button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize = 14}):Play()
            end)
        ...
        function Cont:Toggle(text, callback)
            ...
            Toggle.MouseEnter:Connect(function()
                TweenService:Create(Toggle, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 44, 44)}):Play()
            end)

            Toggle.MouseLeave:Connect(function()
                TweenService:Create(Toggle, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(39, 39, 39)}):Play()
            end)
            ...
            Toggle.MouseButton1Click:Connect(function()
                ...
                if Toggled == false then
                    ...
                    TweenService:Create(Status, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 255, 58)}):Play()
                else
                    Toggled = not Toggled
                    pcall(callback, Toggled)
                    TweenService:Create(Status, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(255, 39, 42)}):Play()
                end
            end)
        ...
        function Cont:Slider(text, min, max, callback)
            ...
            local function slide(input)
                local pos = UDim2.new(math.clamp((input.Position.X - SlideFrame.AbsolutePosition.X) / SlideFrame.AbsoluteSize.X, 0, 1), 0, 1, 0)
        ...
        function Cont:Dropdown(text, list, callback)
            ...
            Dropdown.MouseEnter:Connect(function()
                TweenService:Create(Dropdown, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 44, 44)}):Play()
            end)

            Dropdown.MouseLeave:Connect(function()
                TweenService:Create(Dropdown, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(39, 39, 39)}):Play()
            end)

            Dropdown.MouseButton1Click:Connect(function()
                if DropToggled == false then
                    DropToggled = not DropToggled
                    TweenService:Create(Title, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0.5}):Play()
                    TweenService:Create(DropToggle, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = 360}):Play()
                    Title.Text = Selected
                    DropdownFrame.Visible = true
                    DropdownFrame:TweenSize(UDim2.new(0, 491, 0, DropdownFrameSize), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    DropItemHolder:TweenSize(UDim2.new(0, 470, 0, ItemFrameSize), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    repeat task.wait() until DropdownFrame.Size == UDim2.new(0, 491, 0, DropdownFrameSize)
                    ItemHolder.CanvasSize = UDim2.new(0, 0, 0, ItemHolderUIList.AbsoluteContentSize.Y)
                else
                    DropToggled = not DropToggled
                    TweenService:Create(Title, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
                    TweenService:Create(DropToggle, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = 0}):Play()
                    Title.Text = text
                    DropdownFrame:TweenSize(UDim2.new(0, 491, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    DropItemHolder:TweenSize(UDim2.new(0, 470, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    task.wait(0.05)
                    DropdownFrame.Visible = false
                    repeat task.wait() until DropdownFrame.Size == UDim2.new(0, 491, 0, 0)
                    ItemHolder.CanvasSize = UDim2.new(0, 0, 0, ItemHolderUIList.AbsoluteContentSize.Y)
                end
            end)
            ...
            for i, v in next, list do
                ...
                Option.MouseEnter:Connect(function()
                    TweenService:Create(Option, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 44, 44)}):Play()
                end)

                Option.MouseLeave:Connect(function()
                    TweenService:Create(Option, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(39, 39, 39)}):Play()
                end)
        ...
        function Cont:Colorpicker(text, preset, callback)
            ...
            RainbowToggle.MouseButton1Down:Connect(function()
                ...
                if RainbowColorPicker then
                    TweenService:Create(RainbowStatus, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 255, 58)}):Play()
                ...
                elseif not RainbowColorPicker then
                    TweenService:Create(RainbowStatus, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(255, 39, 42)}):Play()
            ...
            Colorpicker.MouseButton1Click:Connect(function()
                if ColorPickerToggled == false then
                    ...
                    ColorpickerFrame:TweenSize(UDim2.new(0, 491, 0, 111), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    repeat task.wait() until ColorpickerFrame.Size == UDim2.new(0, 491, 0, 111)
                    ItemHolder.CanvasSize = UDim2.new(0, 0, 0, ItemHolderUIList.AbsoluteContentSize.Y)
                else
                    ColorPickerToggled = not ColorPickerToggled
                    ColorpickerFrame:TweenSize(UDim2.new(0, 491, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                    task.wait(0.05)
                    ColorpickerFrame.Visible = false
                    repeat task.wait() until ColorpickerFrame.Size == UDim2.new(0, 491, 0, 0)
                    ItemHolder.CanvasSize = UDim2.new(0, 0, 0, ItemHolderUIList.AbsoluteContentSize.Y)
                end
            end)
        ...
        function Cont:Textbox(text, disapper, callback)
            ...
            TextBox.Focused:Connect(function()
                TextBox:TweenSize(UDim2.new(0, 240, 0, 26), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
            end)
            ...
            TextBox.FocusLost:Connect(function(ep)
                if ep then
                    if #TextBox.Text > 0 then
                        ...
                        TextBox:TweenSize(UDim2.new(0, 192, 0, 26), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true)
                        if disapper then
                            TextBox.Text = ""
                        end
                    end
        ...
        function Cont:Keybind(text, key, callback)
            ...
            Bind.MouseEnter:Connect(function()
                TweenService:Create(Bind, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(44, 44, 44)}):Play()
            end)

            Bind.MouseLeave:Connect(function()
                TweenService:Create(Bind, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(39, 39, 39)}):Play()
            end)
